                ...
                <?php 
                    ...
                    if(isset($_POST['submit']) && $_POST['submit'] === 'Submit'){
                    	...
                    	if(isset($q_name,$q_category,$q_type,$q_topic,$q_level,$q_mark,$q_time,$update_date)){
                    		...
                    		if(empty($q_name) && empty($q_category) && empty($q_type) && empty($q_topic) && empty($q_level) && empty($q_mark) && empty($q_time) && empty($q_option) && empty($q_answer)){
                    		...
                    		if(!empty($messages)){
                    			...
                    			$sql = "UPDATE question SET q_name = '$q_name', q_type = '$q_type', q_category = '$q_category', q_topic = '$q_topic', q_level = '$q_level', q_mark = '$q_mark', q_time = '$q_time', q_option = '$option', q_answer = '$answer', update_date = '$update_date' WHERE id = '$q_id'";
	                                    ...
	                                    <div class="form-group row">
	                                        <div class="col-12">
	                                            ...
	                                            <select name="type" class="form-control">
                                                	...
                                                	<option value="MCQ" <?php if($q_type == 'MCQ') echo 'selected="selected"'; ?> >MCQ</option> 
                                                	<option value="Gap Filling" <?php if($q_type == 'Gap Filling') echo 'selected="selected"'; ?> >Gap Filling</option> 
                                            </select>
	                                        </div>
	                                    </div>
	                                     <div class="form-group row">
                                                ...
                                                <?php $x = 1; foreach ($explode_opt as $option => $opt) { ?>
												  <div class="input-group mb-3">
	                                                <div class="input-group-prepend">
                                                        <?php foreach ($explode_ans as $key => $value) { ?>
    	                                                    <div class="input-group-text">
    	                                                      <input <?php if($value == $x) echo 'checked="checked"' ?> type="checkbox" name="answer[]" value="<?php echo $x; ?>">
    	                                                    </div>
                                                        <?php } ?>
	                                                  </div>
	                                                  <input type="text" name="option[]" class="form-control" placeholder="Enter Your Option" value="<?php echo $opt; ?>">
	                                                </div>
                                                    <?php $x++; } ?>
	                                            </div>
